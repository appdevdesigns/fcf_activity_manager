                                ...
                                _this.webixLayout = webix.ui({
                                    ...
                                    "rows": [
                                        toolbar1,
                                        {
                                            ...
                                            columns:[
                                                {"id":"date_start","header":"date_start"},
                                                {"id":"date_end","header":"date_end"},
                                                {"id":"default_image","header":"default_image","editor":"text"},
                                                {"id":"team","header":"team"},
                                                {"id":"createdBy","header":"createdBy"},
                                                {"id":"approvedBy","header":"approvedBy"},
                                                {"id":"status","header":"status","editor":"text","fillspace":true},
                                                {"id":"id","header":"id"},
                                                {"id":"createdAt","header":"createdAt"},
                                                {"id":"updatedAt","header":"updatedAt"},
