                ...
                'appdev/control/control').then(function () {
                    ...
                    AD.Control.extend('opstools.FCFActivityManager.crud1FCFActivity', {
                        ...
                        prepareEntry:function(l) {
                            ...
                            if (l.date_start)
                                l.attr('date_start', moment.utc(l.date_start).utcOffset(-1,true).toDate());
                            
                            if (l.date_end)
                                l.attr('date_end', moment.utc(l.date_end).utcOffset(-1,true).toDate());
                            
                            if (l.createdAt)
                                l.attr('createdAt', moment.utc(l.createdAt).utcOffset(-1,true).toDate());
                            
                            if (l.updatedAt)
                                l.attr('updatedAt', moment.utc(l.updatedAt).utcOffset(-1,true).toDate());
                        },
